...
export const actions = {
  ...
  async fetchItems ({ commit, state }) {
    ...
    try {
      let response = await api.district.getItems(state.query)
  ...
  createItem ({ commit, dispatch }, form) {
    return api.district.createItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  updateItem ({ commit, dispatch }, form) {
    return api.district.updateItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  deleteItem ({ dispatch }, id) {
    return api.district.deleteItem(id)
      .then(response => {
        dispatch('fetchItems')
