...
export const actions = {
  ...
  async fetchItems ({ commit, state }) {
    ...
    try {
      let response = await api.legalStatus.getItems(state.query)
  ...
  createItem ({ commit, dispatch }, form) {
    return api.legalStatus.createItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  updateItem ({ commit, dispatch }, form) {
    return api.legalStatus.updateItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  deleteItem ({ dispatch }, id) {
    return api.legalStatus.deleteItem(id)
      .then(response => {
        dispatch('fetchItems')
