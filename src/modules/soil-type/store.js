...
export const actions = {
  ...
  async fetchItems ({ commit, state }) {
    ...
    try {
      let response = await api.soilType.getItems(state.query)
  ...
  createItem ({ commit, dispatch }, form) {
    return api.soilType.createItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  updateItem ({ commit, dispatch }, form) {
    return api.soilType.updateItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  deleteItem ({ dispatch }, id) {
    return api.soilType.deleteItem(id)
      .then(response => {
        dispatch('fetchItems')
