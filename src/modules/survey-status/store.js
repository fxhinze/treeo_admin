...
export const actions = {
  ...
  async fetchItems ({ commit, state }) {
    ...
    try {
      let response = await api.surveyStatus.getItems(state.query)
  ...
  createItem ({ commit, dispatch }, form) {
    return api.surveyStatus.createItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  updateItem ({ commit, dispatch }, form) {
    return api.surveyStatus.updateItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  deleteItem ({ dispatch }, id) {
    return api.surveyStatus.deleteItem(id)
      .then(response => {
        dispatch('fetchItems')
