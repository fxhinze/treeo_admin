...
export const actions = {
  ...
  async fetchItems ({ commit, state }) {
    ...
    try {
      let response = await api.project.getItems(state.query)
  ...
  createItem ({ commit, dispatch }, form) {
    return api.project.createItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  updateItem ({ commit, dispatch }, form) {
    return api.project.updateItem(form)
      .then(response => {
        dispatch('fetchItems')
  ...
  deleteItem ({ dispatch }, id) {
    return api.project.deleteItem(id)
      .then(response => {
        dispatch('fetchItems')
